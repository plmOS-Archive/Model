...
namespace plmOS.Model.PropertyTypes
{
    public class Boolean : PropertyType
    {
        public override PropertyTypeValues Type
        {
            get 
            { 
                return PropertyTypeValues.Boolean; 
            }
        }

        internal Boolean(ItemType ItemType, System.Reflection.PropertyInfo PropertyInfo, PropertyAttributes.BooleanPropertyAttribute AttributeInfo, PropertyTypes.Boolean BasePropertyType)
